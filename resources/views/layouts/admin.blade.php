...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/z6vlpwh2impjzbxkdcvrygx9qq566dtmagxt3vtfx8lneadv/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
            ...
            <div class="nav-right ">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{ route('edit.user',Auth::user()->id) }}">Tài khoản</a>
                ...
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active=='product' ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ url('admin/product/cat_parent/list') }}">Danh mục cha</a></li>
                            <li><a href="{{ url('admin/product/cat_pending/list') }}">Danh mục chờ duyệt</a></li>
                            <li><a href="{{ url('admin/product/color') }}">Màu sắc sản phẩm</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-link {{ $module_active=='order' ? 'active' : '' }}">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ url('admin/order/loyal-customer') }}">Khách hàng thân thiết</a></li>
                        </ul>
                    </li>
                    <li class="nav-link {{ $module_active=='contact' ? 'active' : '' }}">
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li><a href="{{ url('admin/contact/list') }}">Danh sách</a></li>
                        </ul>
                    </li>
